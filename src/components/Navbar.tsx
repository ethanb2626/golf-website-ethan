...
const Navbar: React.FC<NavbarProps> = ({ onScrollToSection }) => {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm shadow-sm border-b border-blue-800-100 transition-transform duration-300 ${
              ...
              <div className="w-8 h-8 bg-blue-800-600 rounded-full flex items-center justify-center">
                <div className="w-4 h-4 bg-white rounded-full border-2 border-blue-800-200 relative">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-1 h-1 bg-blue-800-600 rounded-full" />
                  </div>
                </div>
              </div>
              <div>
                ...
                <p className="text-xs text-blue-800-600 leading-tight">Beginner Golf Coach | Miami, FL</p>
              </div>
            </Link>
          </div>
